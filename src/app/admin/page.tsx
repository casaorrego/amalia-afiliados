...
export default function AdminDashboardPage() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: formatCOP(stats ? stats.totalRevenue : 0),
      icon: TrendingUp,
    ...
    },
    {
      ...
      value: formatCOP(stats ? stats.totalEstimatedCommission : 0),
      icon: Wallet,
                  ...
                  {topAffiliates.map((affiliate: any, index: number) => (
                    ...
                    >
                      ...
                      <div className="text-right shrink-0">
                        <p className="text-sm font-semibold">{formatCOP(affiliate.totalRevenue)}</p>
